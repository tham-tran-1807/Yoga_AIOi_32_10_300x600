...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.btn_replay).wait(457).to({_off:false},0).wait(68));
	...
	this.timeline.addTween(cjs.Tween.get(this.mc_mui_ten_xoay).wait(447).to({_off:false},0).to({x:26.65,y:13.75},10,cjs.Ease.quintInOut).wait(68));
...
p.nominalBounds = new cjs.Rectangle(139,284,172,353);
// library properties:
lib.properties = {
